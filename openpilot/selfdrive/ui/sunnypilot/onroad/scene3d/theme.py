...
DAY = Palette(
  ...
  ego_body=(228, 233, 241, 255),
  ego_cabin=(58, 68, 84, 255),
  lead_body=(72, 80, 95, 255),
  lead_cabin=(26, 31, 40, 255),
  blindspot=(250, 176, 60, 70),
  blindspot_edge=(255, 196, 92, 190),
  shadow=(28, 32, 40, 70),
...
NIGHT = Palette(
  ...
  ego_body=(214, 221, 233, 255),
  ego_cabin=(44, 52, 66, 255),
  lead_body=(58, 65, 80, 255),
  lead_cabin=(20, 24, 32, 255),
  blindspot=(250, 168, 48, 78),
  blindspot_edge=(255, 190, 84, 200),
  shadow=(0, 0, 0, 95),
